...
export const CardOverlay = forwardRef(
  ({ title, description, tags, date, ...props }, ref) => {
    return (
      <>
        <div
          ref={ref}
          ...
          className="w-full shrink-0 text-letters font-Poppins cursor-grab active:cursor-grabbing bg-primary px-4 py-3 rounded-xl space-y-1.5"
        >
